...
app.post('/search', async (req, res) => {
  try {
    const { wikiArray, resultTitle } = req.body;
    // TODO: pass in level and title
    console.log('wikiArray inside post:', wikiArray)
